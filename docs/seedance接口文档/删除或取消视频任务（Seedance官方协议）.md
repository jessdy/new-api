...
paths:
  /api/v3/contents/generations/tasks/{task_id}:
    delete:
      summary: 删除或取消视频任务（Seedance官方协议）
      deprecated: false
      description: 取消正在处理的任务，或删除已结束的任务；返回操作后的任务信息。
      operationId: deleteSeedanceTask
      tags:
        - Seedance
        - Seedance
      parameters:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/8772616/apis/api-510573904-run
components:
  schemas: {}
  securitySchemes:
    BearerAuth:
