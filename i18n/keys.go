...
const (
	...
	MsgTokenQuotaPeriodInvalid   = "token.quota_period_invalid"
	MsgTokenPeriodQuotaInvalid   = "token.period_quota_invalid"
	MsgTokenQuotaPeriodUnlimited = "token.quota_period_unlimited"
